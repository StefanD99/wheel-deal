...
function ForgotPassword() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!email) {
            setValues({
                ...values,
                error: 'Please provide valid email adress!'
            });
            return;
        }
        setValues({
        ...
        if (sendEmailResult) {
            showAlert(`Password reset link has been sent to the following email adress: ${email}`);
            setValues({
                ...values,
                loading: false,
                email: ''
            ...
            showAlert('Ooops! Something went wrong while sending!', 'danger');
            setValues({
                ...values,
                loading: false,
            });
            ...
            <Col md={6}>
                ...
                <Form.Group className="mb-3" controlId="formEmail">
                 ...
                 <Form.Text className="text-muted">
                     Enter email to witch your reset password link will be sent
                 </Form.Text>
               </Form.Group>
               <Button onSubmit={loading} variant='primary' type='submit'>
                    Submit
               </Button>
                </Form>
            </Col>
