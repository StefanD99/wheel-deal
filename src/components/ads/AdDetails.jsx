import { Modal, Container, Row, Col, Button, Carousel, Image, OverlayTrigger, Tooltip } from "react-bootstrap";
...
function AdDetails({show, handleClose, adData}) {
    ...
    return (
        ...
        <Modal size="lg" centered show={showZoomModal} onHide={() => {setShowZoomModal(false)}}>
        <Zoom>
            <img
                alt={selectedImage}
                src={selectedImage}
